...
async def run_sse(host: str = "0.0.0.0", port: int = 8001):
    """Run server with SSE transport (for web access)."""
...
SMITHERY_CONFIG = {
    ...
    "description": (
        ...
        "Distance-to-Default (NDD) with 7 signals, structural collapse warnings "
    ...
    "tags": [
        ...
        "crash-prediction", "ndd", "ratings", "blockchain",
